  ...
  return (
    <div className='bg-blue-900 h-14 pl-[1100px] text-white'>
      <div className='text-xl pl-2 '>
        <button className='pl-4 hover:underline'>Home</button>
        <button className='pl-4 hover:underline'>Application</button>
        <button className='pl-4 hover:underline'>Resume</button>
        <button className='pl-4 hover:underline'>LOR</button>
